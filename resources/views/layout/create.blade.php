...
<html lang="en">
  ...
  <div class="card">
    ...
    <div class="card-body">
        <form action="{{url('caategories/create') }}" method="post" enctype="multipart/form-data">  
...
<div class="mb-3">
  ...
  <input name="is_active" type="checkbox" name= "is_active"{{ old('is_active') == true ? 'checked': ''}}>
